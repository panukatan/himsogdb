...
# himsogdb: A database of various publicly-available health and health-related datasets of the Philippines
...
[`R`](https://cran.r-project.org/) workflow for development, curation,
and deployment of `himsogdb` - a database of various publicly-available
health and health-related datasets of the Philippines.
